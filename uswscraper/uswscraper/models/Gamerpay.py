...
class GamerPay_Sale(Base):
    __tablename__ = 'gamerpay_sales'
...
class GamerPay_Listing(Base):
    __tablename__ = 'gamerpay_listings'
    ...
    relationship(
        "SkinVariant",
        back_populates="gamerpay_listings",
        foreign_keys=[skin_variant_id],
    )
    
    def __repr__(self):
        return f"<GamerPay_Listing(id={self.id}, item_name='{self.item_name}')>"